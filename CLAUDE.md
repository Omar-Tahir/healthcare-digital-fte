...
## Memory Files (read when relevant)
- .claude/memory/build-status.md    ← Full BUILD-001..011 + VALIDATE history
- .claude/memory/architecture.md    ← Component map, guardrails, MCP tools, file structure
- .claude/memory/adr-index.md       ← All 14 ADRs with one-line summaries
- .claude/memory/validate-phase.md  ← Remaining VALIDATE tasks, pilot requirements
- .claude/memory/research-index.md  ← DISC-001..005 key findings and sources
